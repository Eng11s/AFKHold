...
<center>
  ...
  <p><b>This mod was made to simulate taping down buttons while AFK. This can be very useful when using any farm that require holding buttons down, or making tedious tasks like walking/boating long distances simple.</b></p>
</center><br>
...
If you need to use mouse while held down, you can hold '**LALT**' to look around in game.

**Mod Settings**
- Mute game while held down
- Disconnect on damage
